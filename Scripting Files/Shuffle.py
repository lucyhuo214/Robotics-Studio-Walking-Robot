...
# calcHips(servo2.get_physical_angle(), 187, servo3.get_physical_angle(), 187, 10)
# time.sleep(2)
...
# while True:
#     calcStep1(servo1.get_physical_angle(), 260, t)
#     time.sleep(0.5)
#     calcStep1(servo1.get_physical_angle(), 60, t)
#     time.sleep(0.5)
...
while True:
    ...
    calcStep1(servo1.get_physical_angle(), 115, t)
